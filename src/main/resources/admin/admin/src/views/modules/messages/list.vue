		...
		<template v-if="showFlag">
			...
			<div :style='{"width":"100%","padding":"0 10px","fontSize":"14px","color":"#000"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='false' :sortable='false' prop="content" label="留言内容">
						<template slot-scope="scope">
							<span class="ql-snow ql-editor" v-html="scope.row.content"></span>
						</template>
					</el-table-column>
					<el-table-column  :resizable='false' prop="cpicture" width="200" label="留言图片">
						<template slot-scope="scope">
					...
					<el-table-column  :resizable='false' prop="rpicture" width="200" label="回复图片">
						<template slot-scope="scope">
