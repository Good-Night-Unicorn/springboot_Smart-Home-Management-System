	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item v-else class="input" label="房间名称" prop="fangjianmingcheng" >
				...
				<el-form-item class="date" v-if="type!='info'" label="控制时间" prop="kongzhishijian" >
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.kongzhishijian" 
						type="datetime"
						:readonly="ro.kongzhishijian"
						placeholder="控制时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item class="input" v-else-if="ruleForm.kongzhishijian" label="控制时间" prop="kongzhishijian" >
					<el-input v-model="ruleForm.kongzhishijian" placeholder="控制时间" readonly></el-input>
				</el-form-item>
				<el-form-item class="select" v-if="type!='info'"  label="控制操作" prop="kongzhicaozuo" >
					<el-select :disabled="ro.kongzhicaozuo" v-model="ruleForm.kongzhicaozuo" placeholder="请选择控制操作" >
						<el-option
				...
				<el-form-item v-else class="input" label="控制操作" prop="kongzhicaozuo" >
					<el-input v-model="ruleForm.kongzhicaozuo"
						placeholder="控制操作" readonly></el-input>
				</el-form-item>
			</template>
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `yuanchengkongzhi/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.yuanchengkongzhiCrossAddOrUpdateFlag = false;
											this.parent.search();
