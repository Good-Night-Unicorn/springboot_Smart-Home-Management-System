	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="date" v-if="type!='info'" label="接单时间" prop="jiedanshijian" >
					<el-date-picker
				...
				<el-form-item class="input" v-else-if="ruleForm.jiedanshijian" label="接单时间" prop="jiedanshijian" >
		...
		methods: {
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'){
					...
					this.ruleForm.weixiuzhuangtai = '待维修'; 				}
				// 获取用户信息
				this.$http({
